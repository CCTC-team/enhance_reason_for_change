Feature: E.125.100 - The system shall support the ability to enable/disable Enhance reason for change external module.
  ...
  Scenario: E.125.100 - Enable external module - Default settings
    ...
    And I should see a table header and row containing the following values in a table:
      ...
      | enhance_reason_for_change | index.php code inserted successfully | Test_Admin |
      | enhance_reason_for_change | Module system enable initiated       | Test_Admin |

    And I logout
    
    Given I login to REDCap with the user "Test_User1"
    When I create a new project named "E.125.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
    ...
    And I should see a table header and row containing the following values in a table:
      | Module                    | Message                              | UserName   |
      | enhance_reason_for_change | index.php code removed successfully  | Test_Admin |
      | enhance_reason_for_change | Module system disable initiated      | Test_Admin |
      | enhance_reason_for_change | index.php code inserted successfully | Test_Admin |
      | enhance_reason_for_change | Module system enable initiated       | Test_Admin |
