Feature: E.125.1500 - RepeatingEvents_DoubleArm_noDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.125.1500" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/ProjectTypes/RepeatingEvents_DoubleArm_noDAGs.xml", and clicking the "Create Project" button

    # ACTION: Import data
    Given I click on the link labeled "Data Import Tool"
    And I upload a "csv" format file located at "fixtures/import_files/RepeatingEvents_DoubleArm_noDAGs.csv", by clicking the button near "Select your CSV data file" to browse for the file, and clicking the button labeled "Upload File" to upload the file
  ...
  Scenario: E.125.100 - Disable external module
    ...
    And I should NOT see "E.125.1500"
