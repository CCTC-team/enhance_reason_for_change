Feature: E.125.2000 - NonRepeating_SingleArm_withDAGs
  ...
  Scenario: E.125.100 - Disable external module
    ...
    Then I should see a table header and row containing the following values in the logging table:
      ...
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "enhance_reason_for_change_v1.1.1" for project                  |                                                                                             |                           |
      | mm/dd/yyyy hh:mm | test_user1 | Update record 1-1 (Event 2) | radio_button_manual = '9..9'	             | Option 4                  |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_reason_for_change_v1.1.1" for project | highlight-field-when-changed-style                                                          |                           |
      | mm/dd/yyyy hh:mm | test_user1 | Update record 1-1 (Event 1) | checkbox(2) = checked	                     | Option 3                  |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_reason_for_change_v1.1.1" for project | reason-for-change-option, highlight-field-when-changed	                                   	|                           |
      | mm/dd/yyyy hh:mm | test_user1 | Update record 1-1 (Event 1) | ptname = 'Name1'                           | Default Option 1          |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_reason_for_change_v1.1.1" for project | provide-reasons-for-change-dropdown, reason-for-change-option, highlight-field-when-changed	|                           |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "enhance_reason_for_change_v1.1.1" for project                   |                                                                                             |                           |
    ...
    Then I should see a table header and row containing the following values in a table:
      | Time             | User       | Event                                                                                   |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "enhance_reason_for_change_v1.1.1" for system                   | 
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "enhance_reason_for_change_v1.1.1" for project                  | 
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_reason_for_change_v1.1.1" for project | 
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "enhance_reason_for_change_v1.1.1" for project                   | 
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_reason_for_change_v1.1.1" for system  | 
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "enhance_reason_for_change_v1.1.1" for system                    |    
