Feature: E.125.2800 - NonLongitudinal_NonRepeatingInstruments_withDAGS
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.125.2800" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/ProjectTypes/NonLongitudinal_NonRepeatingInstruments_withDAGs.xml", and clicking the "Create Project" button
  ...
  Scenario: E.125.100 - Disable external module
    ...
    And I should NOT see "E.125.2800"
