Feature: E.125.100 - The system shall support the ability to enable/disable Enhance reason for change external module.
  ...
  Scenario: E.125.100 - Enable external module - Default settings
    ...
    When I create a new project named "E.125.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
