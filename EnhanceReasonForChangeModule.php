...
if(changeDialog) {
    ...
    /**
     * Hook: Called after this module's configuration is saved
     *
     * Records every changed setting to the module's View Logs page.
     *
     * @param int|string|null $project_id The project ID, or null for a system-scope save
     * @return void
     */
